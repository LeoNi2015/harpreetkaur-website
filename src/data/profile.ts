...
Prior to Google, she led successful cloud migrations at Walmart with a customer-centric approach, delivering high-value experiences, migrations, new products, and services across 600+ legacy applications.`,
  ...
  experience: [
    ...
    },
    {
      ...
      highlight:
        "Strategic customer engagements on infrastructure and AI transformation projects.",
      logo: "G",
      color: "#4285F4",
    },
    {
      company: "Google",
      role: "Senior Technical Solution Consultant",
      period: "May 2022 – May 2025",
      highlight:
        "Drove enterprise cloud and GenAI adoption for strategic accounts.",
      logo: "G",
      color: "#4285F4",
    },
    {
      ...
      highlight:
        "Cloud Solution Architect for Azure, GCP, and OpenStack migrations.",
      logo: "W",
      color: "#0071CE",
    },
    {
      company: "Walmart Global Tech",
      role: "Senior System Engineer / Tech Lead",
      period: "Jan 2019 – Apr 2021",
      highlight:
        "Led Techmod Migration — 600 legacy apps to cloud. Terraform automation at scale.",
      logo: "W",
      color: "#0071CE",
    },
    {
      company: "Walmart Global Tech",
      role: "Advanced System Engineer",
      period: "Sep 2016 – Jan 2019",
      highlight: "Azure PaaS solutions and K8s collaboration projects.",
      logo: "W",
      color: "#0071CE",
    },
    {
      ...
      period: "Aug 2012 – Sep 2013",
      highlight: "Enterprise operations and WebSphere Commerce administration.",
      logo: "IBM",
      color: "#1F70C1",
    },
    {
      ...
      highlight: "Enterprise technical consulting and solution delivery.",
      logo: "HCL",
      color: "#2A7DE1",
    },
    {
      ...
      highlight: "Software engineering foundations in global consulting.",
      logo: "A",
      color: "#A100FF",
    },
  ],
  ...
  awards: [
    ...
    { title: "Make the Difference Award", org: "Walmart", year: "2021" },
    { title: "Leaders Leading Others", org: "Walmart", year: "2018" },
    { title: "Spark Award", org: "Walmart", year: "2016" },
    { title: "Life Saver Award", org: "Walmart", year: "2016" },
    { title: "Team Work Award", org: "Walmart", year: "2015" },
  ],
  education: {
